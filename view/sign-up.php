...
<div class="container">
    ...
    <form name="signup" class="form-horizontal form-registration" method="post" action="/" enctype="multipart/form-data">
        ...
        <div class="form-group required">
            <label for="nickname" class="col-sm-2 control-label"><?=t('Login')?></label>
            <div class="col-sm-10">
        ...
        <div class="form-group required">
            <label for="password" class="col-sm-2 control-label"><?=t('Password')?></label>
            <div class="col-sm-10">
        ...
        <div class="form-group required">
            <label for="password_confirm" class="col-sm-2 control-label"><?=t('Confirmation')?></label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label for="image" class="col-sm-2 control-label"><?=t('Image')?></label>
            <div class="col-sm-10">
